...
public class Keranjang extends AppCompatActivity {
    ...
    DBCakeStore db;
    TextView GrandTotal;
    TextView[] txtCake = new TextView[12],txtPrice = new TextView[12],txtQty = new TextView[12],txtTot = new TextView[12];
    double aSubTotal=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCake[0] = (TextView) findViewById(R.id.txtNama1);
        txtCake[6] = (TextView) findViewById(R.id.txtNama7);
        txtCake[1] = (TextView) findViewById(R.id.txtNama2);
        txtCake[7] = (TextView) findViewById(R.id.txtNama8);
        txtCake[2] = (TextView) findViewById(R.id.txtNama3);
        txtCake[8] = (TextView) findViewById(R.id.txtNama9);
        txtCake[3] = (TextView) findViewById(R.id.txtNama4);
        txtCake[9] = (TextView) findViewById(R.id.txtNama10);
        txtCake[4] = (TextView) findViewById(R.id.txtNama5);
        txtCake[10] = (TextView) findViewById(R.id.txtNama11);
        txtCake[5] = (TextView) findViewById(R.id.txtNama6);
        txtCake[11] = (TextView) findViewById(R.id.txtNama12);
        ...
        if ((cursor != null) && (cursor.getCount() > 0)) {
            for (int cc = 0; cc <= cursor.getCount() - 1; cc++) {
                ...
                txtCake[cc].setText(cursor.getString(2).toString());
        ...
        cursor = dbread.rawQuery("SELECT sum(a.Harga * b.Jumlah) as GrandTotal" +
                " FROM ListKue a join Transaksi b on a.No=b.KodeKue" +
                " Order By a.No", null);
        if ((cursor != null) && (cursor.getCount() > 0)) {
            cursor.moveToFirst();
